...
LauncherBase {
    ...
    Rectangle {
        ...
        PlayButton {
            ...
            text: "Play"
            subText: (isVersionsInitialized && (playVerChannel.licenseStatus !== 10 && playVerChannel.licenseStatus !== 11) /* Fail or Succeeded */
                                                ) ? (( LAUNCHER_ENABLE_GOOGLE_PLAY_LICENCE_CHECK) ? (gameLauncher.running ? "" : (getDisplayedVersionName() ? ("Minecraft " + getDisplayedVersionName()).toUpperCase() : qsTr("Please wait..."))) : "Failed to obtain apk url") : "..."
